...
<body>
    ...
    <div class="jumbotron">
                ...
                <div class="col-md-5">
                    <nav>
                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                          <a class="nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Branches</a>
                          <a class="nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-controls="nav-profile" aria-selected="false">ATM's</a>
                        </div>
                      </nav>
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="input-group mb-3">
                                        <div class="input-group-prepend">
                                            <label class="input-group-text" style="width: 5rem;" for="State">State</label>
                                        </div>
        ...
        <div class="wrappe" style="background-color: grey; margin: 1em 1em; padding: 0em 1em;">
            <div class="row row-cols-1 row-cols-md-3" id="displaybranches/Atms">
            </div>
        </div>
...
?>
        <script type="text/javascript">
            ...
            function displayBranches() {
                ...
                ajaxreq.onreadystatechange = function () {
                    if (ajaxreq.readyState == 4 && ajaxreq.status == 200) {
                        document.getElementById("displaybranches/Atms").innerHTML = ajaxreq.responseText;
                    }
                };
            }
