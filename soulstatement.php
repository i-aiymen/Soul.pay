...
<html lang="en">
  <head>
    ...
    <title>Soul.pay | Statement</title>
...
<?php 
    ...
    ?>
<button type="button" class="button" onclick="printDiv('printarea')">
                ...
                <div class="col-10">
                    ...
                    <div class="row extra-info pt-3">
                        <div class="col-7">
                            ...
                            <p>Account Status: <span><?php echo $row['user_accountstate'] ?></span></p>
                        </div>
                        <div class="col-5">
