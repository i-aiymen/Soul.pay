...
{   
    ...
    $sql = "INSERT INTO `accounts` (`user_id`, `currency`, `user_email`, `user_lastname`, `user_firstname`, `user_accountno`, `user_ifsc`, `limit_per_day_transfer`, `amounts_transferred`, `amounts_from_reserve`, `amounts_from_others`, `user_balance`, `user_accounttype`, `otp`, `otptime`) VALUES (?, 'Rs', ?, ?, ?, ?, 'SOUL0000418', '20000', '', '', '', '5000', 'block', '', '');";
    ...
    mysqli_stmt_bind_param($stmt, "sssss", $userid, $verifyArr['email'], $verifyArr['lname'], $verifyArr['fname'],$useraccountno);
    mysqli_stmt_execute($stmt);
    mysqli_stmt_close($stmt);
